...
%%
for k = 1:300
    FN = ['/Users/ehzawad/Dropbox/Final/original_images/' num2str(k) '.png'];
    RGB = imread(FN);
    tic;
    ...
    toc;
    % Plot saliency maps
    output_FN = ['/Users/ehzawad/Dropbox/Final/saliently_processed_image_sets/model_3/Self_resemblance_by_LARK/' num2str(k) '.png'];
    imwrite(smap_global,output_FN);
    %figure(1)
